...
#table(
  ...
  [`Sw-AHX-KP`], [知识包], [打包提供知识,符合*人类标准化组织*`SH307`预制人标准], [50], [],
  [`Sw-AHX-VC`], [虚拟化容器], [提供容器支持], [120], [],
  [`AXC`], [全功能编译器], [可编译2000+种语言], [1000], [],
  [`ADK`], [深渊开发工具包], [包含编辑器,编译器,解释器,调试器,虚拟环境,可完成全部开发工作], [3000], [],
  [`ADb558`], [558数据库], [基本数据库,支持增查改删], [1000], [],
  [`ADb642`], [642数据库], [进阶数据库], [8000], [],
  [`ADb774`], [774数据库], [高级数据库,以*主宰者数据库*10%的价格实现20%的功能], [$2 times 10^4$], [],
  [`IMG-S-D-Dm`], [主宰者数据库], [仅次于指导数据库的神], [$2 times 10^5$], []
)
...
#table(
  ...
  [`M-AHX-B`], [基本型高端深渊人型奴隶说明书], [基本型高端深渊人型奴隶使用说明], [15], [],
  [`M-AHX-Tl`], [工具型高端深渊人型奴隶说明书], [工具型高端深渊人型奴隶使用说明], [25], [],
  [`M-AHX-Ty`], [玩具型高端深渊人型奴隶说明书], [玩具型高端深渊人型奴隶使用说明], [40], [],
  [`M-AHX-U`], [通用型高端深渊人型奴隶说明书], [通用型高端深渊人型奴隶使用说明], [150], [],
